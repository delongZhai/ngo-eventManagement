...
import { UserRegisterService } from 'src/app/event-comp/userregisterservice.service';
import { userRegisterProperties } from 'src/app/event-comp/userregisterproperties.service';
